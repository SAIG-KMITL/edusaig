  ...
  return (
    <div className="border drop-shadow-md bg-white w-[400px] rounded-md overflow-hidden">
      ...
      <div className="p-4 pt-2 flex flex-col">
        ...
        <p className="text-gray-500">{data.teacher.fullname}</p>
        ...
        <Link
          href={""}
          className="flex justify-center border bg-pink-400 font-bold py-2 rounded border-black border-[3px] hover:bg-pink-300"
        >
          Subscribe
        </Link>
      </div>
